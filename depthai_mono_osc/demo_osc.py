...
#Python3.8 demo_osc.py -e -v -xyz --oscIP "10.100.0.101" --oscPort 12345
...
parser_tracker.add_argument('--IR', type=int, 
                    help="IR illuminator 0-1200 mA")                    
...
while True:
    ...
    mono_manip_frame, body = tracker.next_frame()
    if mono_manip_frame is None: break
    # Draw 3d skeleton
...
#    if args.showVideo is True:
    if args.showVideo:
        ...
        frame = osc_sending.draw(mono_manip_frame, body)
